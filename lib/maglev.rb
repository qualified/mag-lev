...
require 'maglev/web/json_api'
require 'maglev/mongoid/aggregate_builder'
require 'maglev/mongoid/where_filters'
require 'maglev/mongoid/json_api'
require 'maglev/mongoid/query_utils'
require 'maglev/mongoid/elastic_query'
...
require 'maglev/elasticsearch/searchable'
